# Generated by Django 3.2.9 on 2021-11-04 06:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crudapp.contact')),
            ],
            options={
                'db_table': 'phone',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_type', models.CharField(choices=[('birthday', 'Birthday'), ('aniversary', 'Aniversary'), ('other', 'Other')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zipcode', models.IntegerField(max_length=5, validators=[django.core.validators.MinValueValidator(10000), django.core.validators.MaxValueValidator(99999)])),
                ('contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crudapp.contact')),
            ],
            options={
                'db_table': 'address',
